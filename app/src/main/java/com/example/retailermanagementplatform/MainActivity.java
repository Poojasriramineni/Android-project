package com.example.merchantmanagement.Registration;
...
import com.example.merchantmanagement.ManagerMain;
...
import com.example.merchantmanagement.SalespersonMain;
...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (auth.getCurrentUser() != null) {
            ...
            HashMap<String,String> details = s.getUserDetails();

...
import com.example.merchantmanagement.Leaderboard.LeaderBoardObject;
...
import com.example.retailermanagementplatform.SalespersonMain;
        ...
        protected void onCreate(Bundle savedInstanceState) {
            ...
            login.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    Intent intent = new Intent(SalesPersonSignUpActivity.this, LoginActivity.class);
                        ...
                        public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                            ...
                            if(tmp != -1){
                                ...
                                auth.createUserWithEmailAndPassword(email, password)
                                        .addOnCompleteListener(SalesPersonSignUpActivity.this, new OnCompleteListener<AuthResult>() {
                                            @Override
                                            public void onComplete(@NonNull Task<AuthResult> task) {
                                                ...
                                                if (!task.isSuccessful()) {
                                                    Toast.makeText(SalesPersonSignUpActivity.this, "Authentication failed." + task.getException(),
                                                            Toast.LENGTH_SHORT).show();

                                                    Log.e("SSS", String.valueOf(task.getException()));
                                                }
                                                else {
                                                        ...
                                                        public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                                                            for(DataSnapshot snapshot : dataSnapshot.getChildren()){
                                                                if(snapshot.getValue(SalesManager.class).getName().equals(managerName)){
                                                                    ...
                                                                    startActivity(new Intent(SalesPersonSignUpActivity.this, SalespersonMain.class));
                                                                    finish();
